...
public class CourseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String creditsSrt = request.getParameter("credits");
        int credits = 0;
        if(creditsSrt != null && !creditsSrt.equals(""))
            credits = Integer.parseInt(creditsSrt);
        ...
        int maxStudents = 0;
        if(maxStudentsStr != null && !maxStudentsStr.equals(""))
            maxStudents = Integer.parseInt(maxStudentsStr);

        Course course = new Course(courseId, name, credits, semester, maxStudents);
